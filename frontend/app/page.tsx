...
export default function AetherPage() {
  ...
  return (
    <main className="relative min-h-screen flex selection:bg-white/10 selection:text-white">
      <ParticlesBackground />
      <GlowSpotlight />
      ...
      {/* Main Center Content */}
      <div className="flex-1 lg:ml-[260px] xl:mr-[300px] min-h-screen flex flex-col items-center relative z-10">

        {/* Header / Top Bar (Mobile/Tablet only) */}
        <div className="lg:hidden fixed top-0 w-full flex justify-between items-center px-6 py-4 z-50 pointer-events-none">
        ...
        {!showHero && (
          <button
            onClick={clearChat}
            className="fixed top-4 left-[280px] p-2 bg-zinc-900/50 border border-white/10 rounded-full text-zinc-500 hover:text-white transition-all z-50"
        ...
        <footer className="w-full text-center py-6 text-[10px] text-zinc-600 font-medium tracking-tight mt-auto">
          <div className="flex items-center justify-center gap-1.5">
            <span>Unlock new era with HuyRakn.</span>
